  ...
  return (
    <Accordion
      ...
      <AccordionItem value='item-1'>
        <div className='fixed right-8 w-80 bottom-8 bg-blue-200 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 border border-gray-100 bg-primary-content rounded-2xl overflow-hidden'>
